...
CREATE TABLE `setor` (
  ...
  `quantidade_funcionarios` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
...
INSERT INTO `setor` VALUES (1,'Vendas',2500.00,0),(2,'Financeiro',3200.00,0),(3,'Gestão de pessoas',2800.00,0),(4,'Gerente de filial',7500.00,0),(5,'Atendimento ao cliente',1800.00,0),(6,'Almoxarifado',2100.00,0);
...
-- Dump completed on 2025-06-18  4:40:57
