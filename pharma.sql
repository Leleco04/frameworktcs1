...
CREATE TABLE `funcionario` (
  ...
  CONSTRAINT `funcionario_ibfk_1` FOREIGN KEY (`id_setor`) REFERENCES `setor` (`id`)
...
INSERT INTO `funcionario` VALUES (19,'oaiuyfga0sfusaoi','Hideki',127,'Masculino',2,0);
...
CREATE TABLE `negocio` (
  ...
  `data_finalizado` timestamp NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `produto` VALUES (5,'46++../*-','4964',600,850,2,0);
...
-- Dump completed on 2025-06-16 15:48:38
